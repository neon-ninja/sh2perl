...
my $line_count = do {
    ...
    my $wc_line_count_6_1 = scalar @wc_lines_6_1;
    $output_6 = q{};
    $output_6 .= "$wc_line_count_6_1 ";
    $output_6 =~ s/\s+$//msx;
...
TIMING COMPARISON
==================================================
Perl execution time:  0.0664 seconds
Bash execution time:  1.5365 seconds
Perl is 23.16x faster than Bash

==================================================
OUTPUT COMPARISON
==================================================
╬ô┬ú├╣ DIFFERENCES FOUND:

STDOUT DIFFERENCES:
--- bash_stdout
+++ perl_stdout
-=== Text Processing Commands ===
-First 5 lines of main.rs:
-mod cache;
-mod execution;
-mod utils;
-mod testing;
-mod cli_commands;
-Lines containing 'fn':
-24:fn fix_command_substitution_placeholders(mut code: String) -> String {
-31:fn main() {
-36:fn main_with_args(args: Vec<String>) {
-1170:    fn test_lexer_basic() {
-1183:    fn test_parser_basic() {
