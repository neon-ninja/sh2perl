...
if (@{$err}) {
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_5 = do {
    my $cmd_result_7 = ("Move successful");
    chomp $cmd_result_7;
    $cmd_result_7;
};
...
croak "rm: ", "test_file_moved.txt",
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_10 = do {
    my $cmd_result_12 = ("Remove successful");
    chomp $cmd_result_12;
    $cmd_result_12;
};
...
croak "mkdir: cannot create directory test_dir: File exists\n";
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_15 = do {
    my $cmd_result_17 = ("Directory created");
    chomp $cmd_result_17;
    $cmd_result_17;
};
...
croak "touch: cannot create ", "test_file.txt", ": $ERRNO\n";
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_21 = do {
    my $cmd_result_23 = ("File touched");
    chomp $cmd_result_23;
    $cmd_result_23;
};
